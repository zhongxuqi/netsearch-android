...
public final class CameraManager {
	...
	private static final int MAX_FRAME_HEIGHT = 1920; // = 5/8 * 1080
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			int height = findDesiredDimensionInRange(screenResolution.x,
					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			LogUtils.d("zxq", width + ";" + height);
...
//			LogUtils.d("zxq","getFramingRectInPreview: "+
//					rect.left+";"+
//					rect.right+";"+
//					rect.top+";"+
//					rect.bottom);
