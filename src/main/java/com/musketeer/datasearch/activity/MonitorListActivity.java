...
import com.musketeer.datasearch.adapter.MonitorListAdapter;
...
public class MonitorListActivity extends BaseActivity {
    public static final String TAG = "MonitorListActivity";
    ...
    protected MonitorListAdapter mAdapter;
    protected MonitorResultResp info;
    ...
    public void initView() {
        ...
        mAdapter = new MonitorListAdapter(this);
    ...
    public void initEvent() {
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener<SearchResultEntity>() {
            ...
            public void onClick(SearchResultEntity item) {
                switch (SharePreferenceUtils.getInt(MonitorListActivity.this, SharePreferenceConfig.LOAD_WAY, AppContant.WEBVIEW_LOAD)) {
        ...
        mAdapter.setRecordListener(new UnionListAdapter.OnRecordListener() {
            @Override
            public void onRecordClick(View v, SearchResultEntity entity, boolean isRecord) {
                SearchResultManager.getInstance().recordSearchResult(MonitorListActivity.this, v, entity, isRecord);
    ...
    public void initData() {
        ...
        info = MainApplication.getInstance().getMonitorRespDao().getDataById(bundle.getInt("id"));
        info.setNew(false);
        MainApplication.getInstance().getMonitorRespDao().update(info);
